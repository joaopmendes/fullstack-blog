...
export const Button = ({type, onClick, disabled, children, size, backgroundColor, ...rest}) => {
    let render;
    switch(type) {
        case "anchor":
            render = <StyledAnchor onClick={onClick} disabled={disabled} size={size} backgroundColor={backgroundColor} {...rest}>
                {children}
            </StyledAnchor>;
            break;
        case "button":
            render = <StyledButton onClick={onClick} disabled={disabled} size={size} backgroundColor={backgroundColor} {...rest}>
            {children}
        </StyledButton>;
            break;
        default:
